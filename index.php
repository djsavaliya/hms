...
<br><br>
      ...
      <a href="student_signup.php" class="btn brand z-depth-0">Signup</a>
      </span>
    </h6>
    </form>
  ...
  Not a student? Click <a href="manager-adminLogin.php" class="blue-text text-darken-2 z-depth-0">HERE</a> to login 
  </h5>

  <center>
  	
  	<a href="forgot_psw.php"><u>Forgot Password</u></a>
